          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="flex gap-4">
                ...
                <a
                  href="https://www.linkedin.com/in/altais-racing-717352395/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-[#FFFFFE]/10 w-10 h-10 rounded-full flex items-center justify-center hover:bg-[#FFFFFE] hover:text-[#01123D] transition-all"
                  aria-label="LinkedIn"
                ...
                <a
                  href="https://www.youtube.com/@AltaisRacing"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-[#FFFFFE]/10 w-10 h-10 rounded-full flex items-center justify-center hover:bg-[#FFFFFE] hover:text-[#01123D] transition-all"
                  aria-label="YouTube"
              ...
              <div className="mt-6">
                <div className="bg-[#FFFFFE]/10 rounded-lg p-4 inline-block">
                  <img
                    src="/brand/theCryptSchoolLogo.png"
                    alt="The Crypt School Logo"
