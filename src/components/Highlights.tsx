  ...
  const stats = [
    {
      ...
      description: 'Development class debut'
    },
    {
      icon: Trophy,
      number: 'Pro',
              ...
              >
                <div className="flex items-center gap-6">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-[#FFFFFE]/80 mb-4">Download our partnership deck to explore sponsorship tiers, benefits, and how your support accelerates our journey to nationals and the World Finals.</p>
                    <div className="flex gap-3">
                      <button className="border border-[#FFFFFE]/30 text-[#FFFFFE] px-6 py-2 rounded-full hover:bg-[#FFFFFE]/6 transition-colors">Download Deck</button>
                    </div>
                  </div>
                </div>
              </div>
